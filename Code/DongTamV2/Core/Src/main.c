...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  HC595 _hc595 = {
		  .GPIO_CLK_PORT 	= _74HC595_CLK_GPIO_Port,
		  .GPIO_CLK_PIN 	= _74HC595_CLK_Pin,
		  .GPIO_DATA_PORT 	= _74HC595_DATA_GPIO_Port,
		  .GPIO_DATA_PIN	= _74HC595_DATA_Pin,
		  .GPIO_LATCH_PORT 	= _74HC595_STORE_GPIO_Port,
		  .GPIO_LATCH_PIN	= _74HC595_STORE_Pin
  };
  HC595_Send_Data(&_hc595, 0x01);
  /* USER CODE END 2 */
